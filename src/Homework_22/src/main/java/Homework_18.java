...
public class Homework_18 {
    ...
    @FindBy(xpath = "//*[@id=\"sort_by\"]/ul/li[1]")
    private WebElement recomendationsForBooking;
    ...
    public boolean recomendationsArePresent() {
        return recomendationsForBooking.isDisplayed();
    }
